...
function App() {
  ...
  useEffect(() => {
    // Fetch warehouse data from your JSON file or an API
    // Update 'warehouseData' with the fetched data
  }, []);
  ...
  return (
    ...
    <Routes>
          ...
          <Route path="/" exact component={WarehouseListing} />
          <Route path="/details/:id" component={WarehouseDetails} />
          </Routes>
      </Router>
  );
}
